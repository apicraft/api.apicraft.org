var guidelines = {
	"promises":[
		{
			"title":"Each attendee's topics will have been raised, if the attendee took responsibility for raising them."	
		},
		{
			"title":"All issues will have recieved full discussion to the extent desired."
		},
		{
			"title":"A full report of issues and discussions will be available to all participants."
		}
	],
	"principles":[
		{
...
module.exports = function(handle) {
  handle('request', function(env, next) {
   // var g = guidelines;
    ...
    //env.response.setHeader('Content-Length', 3548);
    env.response.statusCode = 200;
    env.response.body = guidelines;
